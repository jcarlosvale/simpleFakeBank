...
public class SwaggerConfiguration {
    ...
    private static final String API_TITLE = "Simple Bank API";
    private static final String APPLICATION_JSON = "application/json";

    private static final String CONTACT_EMAIL = "jcarlos.vale@gmail.com";
    private static final String CONTACT_URL = "https://www.linkedin.com/in/joaocarlosvale/";
    private static final String CONTACT_NAME = "Joao Carlos Sousa do Vale";
